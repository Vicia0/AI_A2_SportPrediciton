...
players_df = pd.read_csv('/content/drive/My Drive/AI Course/players_22.csv')
...
df_test = pd.read_csv('/content/drive/My Drive/AI Course/players_21.csv')
...
joblib.dump(clf, 'fifa22_model.pkl')
